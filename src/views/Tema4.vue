...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg-full-width.bg-fondo-2
      .p-4.p-md-5
        div.tarjeta-horz(data-aos="zoom-in").mb-5
          ...
          div
            p.mb-0 Los elementos externos del mercado corresponden a factores que influyen de manera directa o indirecta en la competitividad, sostenibilidad y desempeño estratégico de una empresa, pero sobre los cuales esta no tiene control directo. <b>Estos factores incluyen dimensiones como:</b>
          ...
          .col-lg-8.order-lg-1
            .bloque-texto-b.color-secundario.p-4
              .bloque-texto-b__texto
                i.fas.fa-quote-left
                h4.mb-0 Según Porter (2008), un análisis riguroso de estos elementos permite a las organizaciones anticiparse a los cambios del entorno, diseñar estrategias más resilientes y minimizar vulnerabilidades frente a situaciones externas adversas. Ignorar estos factores puede llevar a decisiones erróneas, pérdida de oportunidades clave y desventajas competitivas en mercados dinámicos.
    ...
    .cajon.color-acento-botones.p-4.mb-4.bg-color-8
      p.mb-0 Factores externos que afectan la competitividad de las empresas y no pueden ser controlados directamente. Porter (2008) destaca que una correcta evaluación de estos factores permite formular estrategias más resilientes.
